    ...
    <div className={(selectedConversation != null && con._id == selectedConversation._id) ? 'col-lg-12 p-2 highlight-selected rounded selected mt-1' : 'col-lg-12 p-2 highlight-selected rounded mt-1'}>
      <div className="d-flex w-100 justify-content-between align-items-center">
        ...
        <div className='container-fluid px-2'>
          ...
          <div className='row'>
            <div className='col-lg-7'>
              {/* {(con.latestMessage && con.latestMessage.type === 'text') && <p className='mb-0 px-2 text-truncate'>{con.latestMessage.content}</p>}
              {(con.latestMessage && con.latestMessage.type === 'notification') && <p className='mb-0 px-2 text-truncate'>{con.latestMessage.content}</p>} */}
